...
return [
    'workspaces' => [
        ...
        'laboratory' => [
            'title' => 'console.workspaces.laboratory.title',
            'description' => 'console.workspaces.laboratory.description',
            'icon' => 'microscope',
            'group' => 'workflow',
            'permissions' => [PermissionName::ViewLaboratory->value, PermissionName::ViewInventory->value],
            'tabs' => ['testing_queue', 'blood_units', 'expiry'],
        ],
        'components' => [
            'title' => 'console.workspaces.components.title',
            'description' => 'console.workspaces.components.description',
            'icon' => 'network',
            'group' => 'workflow',
            'permissions' => [PermissionName::ViewComponents->value, PermissionName::ViewInventory->value],
            'tabs' => ['blood_units', 'testing_queue', 'disposal'],
        ],
        'inventory' => [
            'title' => 'console.workspaces.inventory.title',
            'description' => 'console.workspaces.inventory.description',
            'icon' => 'package-check',
            'group' => 'workflow',
            'permissions' => [PermissionName::ViewInventory->value],
            'tabs' => ['inventory', 'transfers', 'expiry', 'disposal'],
        ],
        'logistics' => [
            'title' => 'console.workspaces.logistics.title',
            'description' => 'console.workspaces.logistics.description',
            'icon' => 'truck',
            'group' => 'workflow',
            'permissions' => [PermissionName::ViewLogistics->value, PermissionName::ManageInventoryTransfers->value],
            'tabs' => ['transfers', 'inventory', 'expiry'],
        ],
        'hospital' => [
            'title' => 'console.workspaces.hospital.title',
            'description' => 'console.workspaces.hospital.description',
            'icon' => 'hospital',
            'group' => 'workflow',
            'permissions' => [PermissionName::ViewHospitalRequests->value, PermissionName::ManageHospitalRequests->value, PermissionName::ManageBloodIssue->value],
            'tabs' => ['requests', 'compatibility', 'issue', 'transfusion'],
        ],
        'quality' => [
            'title' => 'console.workspaces.quality.title',
            'description' => 'console.workspaces.quality.description',
            'icon' => 'shield-check',
            'group' => 'workflow',
            'permissions' => [PermissionName::ViewQuality->value, PermissionName::ManageQuality->value, PermissionName::ViewAudits->value],
            'tabs' => ['reactions', 'recalls', 'capa', 'audits'],
        ],
        'response' => [
