...
Email verification is disabled while the system is under construction. Re-enable it only after the pilot security decision recorded in `docs/planning/workflow.md`.
