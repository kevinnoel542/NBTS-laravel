...
CREATE TABLE `blood_centers` (
  ...
  `capacity_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `blood_units` (
  ...
  `status` enum('collected','testing','available','reserved','transferred','used','rejected','expired','discarded') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'collected',
...
CREATE TABLE `campaigns` (
  ...
  `campaign_type` enum('standard','emergency') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'standard',
  `target_blood_group` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `center_staff` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `blood_center_id` bigint unsigned NOT NULL,
  `position` enum('center_manager','center_staff') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'center_staff',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `donations` (
  ...
  `donation_type` enum('appointment','walk_in') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'appointment',
...
CREATE TABLE `donor_profiles` (
  ...
  `blood_group_status` enum('unknown','user_selected','staff_verified') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
  `blood_group_verified` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `eligibility_status` enum('eligible','not_yet_eligible','temporarily_deferred','permanently_deferred') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'eligible',
  ...
  `loyalty_tier` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `donor_rewards` (
  ...
  `status` enum('earned','redeemed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'earned',
  `awarded_at` timestamp NOT NULL,
...
CREATE TABLE `eligibility_records` (
  ...
  `status` enum('eligible','not_yet_eligible','temporarily_deferred','permanently_deferred') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `leaderboards` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `period` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all_time',
...
CREATE TABLE `low_stock_alerts` (
  ...
  `status` enum('open','notified','campaign_created','resolved') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
...
CREATE TABLE `sms_reminder_logs` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `reminder_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('donor','admin','staff') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'donor',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `firebase_provider` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
